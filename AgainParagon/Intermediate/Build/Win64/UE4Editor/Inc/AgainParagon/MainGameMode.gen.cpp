...
#include "AgainParagon/MainGameMode.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	AGAINPARAGON_API UClass* Z_Construct_UClass_AMainGameMode_NoRegister();
	AGAINPARAGON_API UClass* Z_Construct_UClass_AMainGameMode();
	ENGINE_API UClass* Z_Construct_UClass_AGameModeBase();
	UPackage* Z_Construct_UPackage__Script_AgainParagon();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMainGameMode_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_AgainParagon,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AMainGameMode_Statics::ClassParams = {
		...
		0,
		0x009002A8u,
		METADATA_PARAMS(Z_Construct_UClass_AMainGameMode_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AMainGameMode_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AMainGameMode, 1744658315);
	template<> AGAINPARAGON_API UClass* StaticClass<AMainGameMode>()
	{
		return AMainGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMainGameMode(Z_Construct_UClass_AMainGameMode, &AMainGameMode::StaticClass, TEXT("/Script/AgainParagon"), TEXT("AMainGameMode"), false, nullptr, nullptr, nullptr);
