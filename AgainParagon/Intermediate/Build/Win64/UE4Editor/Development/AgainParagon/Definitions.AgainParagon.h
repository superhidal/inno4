#undef AGAINPARAGON_API
#undef AGAINPARAGON_VTABLE
...
#define UE_PROJECT_NAME AgainParagon
...
#define AGAINPARAGON_VTABLE DLLEXPORT_VTABLE
#define AGAINPARAGON_API DLLEXPORT
